...
document.querySelector("#btn12").addEventListener("click", function(){
	...
	const obj = { name : name, 
				job : {location: location, since : since} };
...
document.querySelector("#btn10").addEventListener("click", function(){
	const o = {name : "son" , age : 34 , hasCar: ture, food: ["피자","커피"]};
...
document.querySelector("#btn6").addEventListener("click",function(){
	fetch(ctx + "/ex44/sub06" , {
		...
		body : `{"name":"son","job" : {"location":"london","since":"2000년"}}`
		/* job property안에 객체 */
	});
});
...
document.querySelector("#btn5").addEventListener("click",function(){
	fetch(ctx + "/ex44/sub05" , {
		method : "post",
		headers : {"Content-Type" : "application/json"},
		body : `{"address":"seoul","score":23.5,"phone":["010","3333"],"married":false}`
	});
});
