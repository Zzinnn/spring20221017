...
public class CustomApplicationListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce)  { 
    	...
    	// https://study-new-bucket01.s3.ap-northeast-2.amazonaws.com/prj1/board
    	ServletContext application = sce.getServletContext();
    	application.setAttribute("imgUrl", "https://study-new-bucket01.s3.ap-northeast-2.amazonaws.com/prj1/board");
