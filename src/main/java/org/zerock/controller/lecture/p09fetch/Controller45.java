...
//		return ResponseEntity.notFound().build();
	...
	@GetMapping("sub02")
	public ResponseEntity mehtod02() {
//		return ResponseEntity.status(202).build();
	...
	@GetMapping("sub03")
	public ResponseEntity mehtod03() {
	...
	@GetMapping("sub06")
	public ResponseEntity<JavaBean24> mehtod06(){
	...
	/*
	 * ResponseBody : body만 사용해도 될 때
	 * ResponseEntity : status(상태코드), header 사용될 때
	 */
